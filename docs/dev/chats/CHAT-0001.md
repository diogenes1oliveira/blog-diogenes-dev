...
I've created [`LLM-PARAMS.md`](LLM-PARAMS.md) with the full reference. Here's
...
- `LLM-PARAMS.md` — created with the full LLM parameters reference
...
| LLM Parameters       | `LLM-PARAMS.md` (already existed) |
